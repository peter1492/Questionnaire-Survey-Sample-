...
public class Fragment2BindingImpl extends Fragment2Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.answer_2_rg, 6);
        sViewsWithIds.put(R.id.next_2, 7);
    }
    // views
    @NonNull
    ...
    public Fragment2BindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private Fragment2BindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.option1Ques2.setTag(null);
        this.option2Ques2.setTag(null);
        this.option3Ques2.setTag(null);
        this.option4Ques2.setTag(null);
        this.question2Text.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.option1Ques2, questionOption1);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.option2Ques2, questionOption2);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.option3Ques2, questionOption3);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.option4Ques2, questionOption4);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.question2Text, questionQuestion);
        }
    }
