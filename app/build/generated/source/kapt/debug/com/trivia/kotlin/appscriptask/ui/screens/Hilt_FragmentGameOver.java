...
public abstract class Hilt_FragmentGameOver extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentGameOver() {
    super();
  }

  Hilt_FragmentGameOver(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentGameOver_GeneratedInjector) this.generatedComponent()).injectFragmentGameOver(UnsafeCasts.<FragmentGameOver>unsafeCast(this));
    }
  }
