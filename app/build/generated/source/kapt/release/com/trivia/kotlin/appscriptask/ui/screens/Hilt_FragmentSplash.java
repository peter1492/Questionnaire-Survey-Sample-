...
public abstract class Hilt_FragmentSplash extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentSplash(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentSplash_GeneratedInjector) this.generatedComponent()).injectFragmentSplash(UnsafeCasts.<FragmentSplash>unsafeCast(this));
    }
  }
