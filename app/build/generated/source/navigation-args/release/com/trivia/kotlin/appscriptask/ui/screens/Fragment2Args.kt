...
public data class Fragment2Args(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): Fragment2Args {
      bundle.setClassLoader(Fragment2Args::class.java.classLoader)
      ...
      return Fragment2Args(__summary)
    }
  }
}
